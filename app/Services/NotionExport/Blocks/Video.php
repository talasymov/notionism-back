...
class Video extends AbstractBlock implements FileInterface
{
    public function render(): string
    {
        ...
        return sprintf(
            '<div class="notion-video"><video muted="muted" loop="loop" autoplay="autoplay" class="video"><source src="%s" type="video/mp4"></video></div>',
